...
const Dashboard = () => {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // Sidebar hidden by default on mobile
  ...
  return (
    <div className="relative flex">
      ...
      <div
        ...
        } md:translate-x-0 fixed md:static inset-y-0 left-0 z-30 w-64 bg-white transition-transform duration-300 ease-in-out`}
      >
        <Sidebar
          userData={userData}
