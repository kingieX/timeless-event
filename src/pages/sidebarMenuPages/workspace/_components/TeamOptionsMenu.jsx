...
const TeamOptionsMenu = ({ teamId, team, teamName, onTeamUpdated }) => {
  const [isLoading, setIsLoading] = useState(false);
  //   console.log('team details:', team.team_id);
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <ul className="absolute w-40 right-0 mt-2 bg-white border border-slate-300 rounded shadow-lg z-10">
          <li
...
export default TeamOptionsMenu;
