...
const ViewSubtaskReminderModal = ({ subtaskId, onClose }) => {
    ...
    const fetchReminders = async () => {
      ...
      try {
        const response = await fetch(
          `${API_BASE_URL}/reminder/subtasks/${subtaskId}/reminders/`,
          {
            method: 'GET',
            headers: {
  ...
  return (
    <div className="fixed inset-0 flex items-start justify-center z-50 bg-gray-500 bg-opacity-50">
      <div className="bg-white p-6 w-full max-w-xl m-8 overflow-y-auto h-[80vh] border border-gray-300 rounded-lg shadow-lg">
...
export default ViewSubtaskReminderModal;
